    ...
    Linux_Drivers_menu(){
        Graphical_Drivers_menu() {
            ...
            NVIDIA_Geforce_Driver_menu() {
                Nvidia_Geforce_Packages() {
                    ...
                    do
                        case_menu_Software NVIDIA_Geforce_Drivers_menu PACKAGE_${Nvidia_Geforce_Packages_options}
                    done
                }
                Nvidia_Geforce_304xx_Packages() {
                    ...
                    do
                        case_menu_Software NVIDIA_Geforce_Drivers_menu PACKAGE_${Nvidia_Geforce_304xx_Packages_options}
                    done
                }
                Nvidia_Geforce_340xx_Packages() {
                    ...
                    do
                        case_menu_Software NVIDIA_Geforce_Drivers_menu PACKAGE_${Nvidia_Geforce_340xx_Packages_options}
                    done
                }
                Nvidia_Geforce_Extra_Packages() {
                    ...
                    do
                        case_menu_Software NVIDIA_Geforce_Drivers_menu PACKAGE_${Nvidia_Geforce_Extra_Packages_options}
                    done
                }
                Nvidia_Geforce_Cuda_Packages() {
                    ...
                    do
                        case_menu_Software NVIDIA_Geforce_Driver_menu Driver_${Nvidia_Geforce_Cuda_Packages_options}
                    done
                }
            #
            # NVIDIA_Geforce_Driver_menu
            ...
            # 7. exit - Exit program
                ...
                do
                    ...
                    case_menu_Software Graphical_Drivers_menu ${NVIDIA_Geforce_Driver_menu_options}
                done
            }
            AMD_Catalyst_Driver_menu(){
                    ...
                    # 6. exit - Exit program
                        ...
                        do
                            ...
                            case_menu_Software AMD_Catalys_Drivers_menu ${Catalyst_repo_menu_options}
                        done
                    }
                    ...
                    # 16. exit - Exit program
                        PS3="$Catalyst_Driver_Packages_message"
                            ...
                            do
                                # case_menu_Software ${Catalyst_repo_menu_options} Graphical_Drivers_menu
                                case_menu_Software AMD_Catalys_Drivers_menu PACKAGE_${Catalyst_Driver_Packages_options}
                            done
            ...
            # TODO: add the AMD_Catalyst_Driver_menu_message to the message.sh
                ...
                select AMD_Catalyst_Driver_menu_options in Catalyst_repo_menu Catalyst_Driver_Packages back exit
                    do
                        ...
                        case_menu_Software Graphical_Drivers_menu ${AMD_Catalyst_Driver_menu_options}
                    done
            }
        #
        # Graphical_Drivers_menu
        ...
        #TODO: add the Graphical_menu_message to message.sh
            ...
            do
                ...
                case_menu_Software Linux_Drivers_menu ${Graphical_Drivers_menu_option}
            done
        }
        Audio_Drivers_menu() {
            Pulse_Audio_Packages_menu() {
                ...
                do
                    case_menu_Software Audio_Driver_menu Driver_${Pulse_Audio_Packages_option}
                done
            }
            JACK_Kit_menu() {
            #
            ...
            # 6. exit - Exit program
                ...
                PS3="$JACK2_Kit_menu_message"
                    ...
                    do
                        ...
                        case_menu_Software Audio_Drivers_menu PACKAGE_${JACK2_Kit_menu_options}
                    done
            ...
            # 12. exit - Exit program
                ...
                do
                    ...
                    case_menu_Software Audio_Drivers_menu PACKAGE_${ALSA_Driver_menu_options}
        ...
        # TODO: add the Audio_Drivers_menu_message to message.sh
            ...
            do
                case_menu_Software Linux_Drivers_menu ${Audio_Drivers_menu_option}
        ...
        do
            case_menu_Software Software_menu ${Linux_Drivers_menu_option}
            # case_menu_Software ${Linux_Drivers_menu_option} Software_menu
        done
    }
    ...
    Linux_Kernels_menu() {
        ...
        AUR_Kernels() {
            ...
            select AUR_Kernels_options in linux-rt linux-rt-headers linux-mainline linux-mainline-headers linux-ck linux-ck-headers back exit
                ...
                case_menu_Software Linux_Kernels_menu PACKAGE_AUR_${AUR_Kernels_options}
            done
        }
        ...
        OFFICIAL_Kernels() {
            ...
            do
                ...
                case_menu_Software Linux_Kernels_menu PACKAGE_${OFFICIAL_Kernels_options}
            done
        }
        #
        # Linux_Kernels_menu
        ...
        do
            # case_menu_boot AURK_PACKAGE_${OFFICIAL_Kernels_options} Linux_menu
            case_menu_Software Software_menu ${OFFICIAL_Kernels_options}
        done
    }
    # Software_menu
    #
...
Install_Selected_Packages() {
    ...
    print  "${Install_Selected_Packages}"
...
Repo_install() {
    local repo=$1
    printf -P "$CF[99] adding $repo as a new repo $CF[256]"
